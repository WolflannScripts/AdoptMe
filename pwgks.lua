...
task.spawn(function()
    local success, errorMessage = pcall(function()
        ...
        spawnButton.MouseButton1Click:Connect(function()
            ...
            if petName and petName ~= "" then
                task.spawn(function()
                    statusLabel.Text = "âŒ› Searching pet..."
                    statusLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
                    ...
                    if petId then
                        ...
                        if success and result then
                            statusLabel.Text = "âœ… Pet Spawned: " .. petName .. " (" .. selectedType .. ")"
                            ...
                            statusLabel.Text = "âŒ Failed to spawn pet."
                        ...
                        statusLabel.Text = "âŒ Pet Not Found: " .. petName
                        statusLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
                ...
                statusLabel.Text = "âŒ Please enter a pet name."
                statusLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
            end
        end)
    end)
    ...
    if not success then
        statusLabel.Text = "âš ï¸ Backend failed: " .. tostring(errorMessage)
